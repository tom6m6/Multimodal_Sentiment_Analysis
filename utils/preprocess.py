...
if __name__ == '__main__':
    trainloc = 'data/train.txt'
    testloc = 'data/test_without_label.txt'
    # ResNet
    image_feats = get_resnet_feats(trainloc)
    json.dump({'img_feats': image_feats}, open('saved/resnet_train.json', 'w'))
    image_feats = get_resnet_feats(testloc)
    json.dump({'img_feats': image_feats}, open('saved/resnet_test.json', 'w'))
    ...
    text_feats, fname = bert_embeddings(testloc, text_transform)
    json.dump({'txt_feats': text_feats, 'fname': fname}, open('saved/roberta_test.json', 'w'))
    ...
    img_feats, text_feats, _ = get_clip_feats(testloc, text_transform)
    json.dump({'img_feats': img_feats, 'txt_feats': text_feats}, open('saved/clip_test.json', 'w'))
